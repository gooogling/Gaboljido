...
|            이름             |            이름             |            이름             |
|:--------------------------:|:--------------------------:|:--------------------------:|
| <img width="200" src="https://github.com/user-attachments/assets/84d5a6e0-f7ad-42fa-80c5-23508acb47c1" /> | <img width="200" src="사진" /> | <img width="200" src="사진" /> |
|       BE        |       역할<br/>역할        |       역할<br/>역할        |
|     [@방가윤](링크)     |     [@이름](링크)     |     [@이름](링크)     |

|            이름             |            이름             |            이름             |
|:--------------------------:|:--------------------------:|:--------------------------:|
| <img width="200" src="사진" /> | <img width="200" src="사진" /> | <img width="200" src="사진" /> |
|       역할<br/>역할        |       역할<br/>역할        |       역할<br/>역할        |
|     [@이름](링크)     |     [@이름](링크)     |     [@이름](링크)     |
